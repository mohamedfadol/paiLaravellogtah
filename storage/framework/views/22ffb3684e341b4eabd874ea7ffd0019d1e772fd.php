		...
		<!--Sidemenu css -->
        <link  href="<?php echo e(URL::asset('public_theme/assets/css-rtl/sidemenu.css')); ?>" rel="stylesheet">

		<!-- P-scroll bar css-->
		<link href="<?php echo e(URL::asset('public_theme/assets/plugins/p-scrollbar/p-scrollbar-rtl.css')); ?>" rel="stylesheet" />
		...
		<!-- Simplebar css -->
		<link rel="stylesheet" href="<?php echo e(URL::asset('public_theme/assets/plugins/simplebar/css/simplebar-rtl.css')); ?>">
	    <!-- Color Skin css -->
		<link id="theme" href="<?php echo e(URL::asset('public_theme/assets/colors-rtl/color1.css')); ?>" rel="stylesheet" type="text/css"/>



<?php /**PATH C:\xampp\htdocs\apiLaravelLogtah\resources\views/layouts/theme/head.blade.php ENDPATH**/ ?>