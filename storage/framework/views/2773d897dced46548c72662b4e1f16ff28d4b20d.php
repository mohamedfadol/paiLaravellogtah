									...
									<div class="d-flex order-lg-2 mr-auto">
										...
										<div class="dropdown header-message">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class="header-dropdown-list message-menu" id="message-menu">
													<a class="dropdown-item border-bottom" href="<?php echo e(url('/' . $page='#')); ?>">
														<div class="d-flex align-items-center">
															<div class="">
																<span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?php echo e(URL::asset('public_theme/assets/images/users/1.jpg')); ?>"></span>
															</div>
															<div class="d-flex">
																<div class="pr-3">
													...
													<a class="dropdown-item border-bottom">
														<div class="d-flex align-items-center">
															<div class="">
																<span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?php echo e(URL::asset('public_theme/assets/images/users/2.jpg')); ?>"></span>
															</div>
															<div class="d-flex">
																<div class="pr-3">
													...
													<a class="dropdown-item border-bottom">
														<div class="d-flex align-items-center">
															<div class="">
																<span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?php echo e(URL::asset('public_theme/assets/images/users/3.jpg')); ?>"></span>
															</div>
															<div class="d-flex">
																<div class="pr-3">
													...
													<a class="dropdown-item border-bottom">
														<div class="d-flex align-items-center">
															<div class="">
																<span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?php echo e(URL::asset('public_theme/assets/images/users/4.jpg')); ?>"></span>
															</div>
															<div class="d-flex">
																<div class="pr-3">
													...
													<a class="dropdown-item border-bottom">
														<div class="d-flex align-items-center">
															<div class="">
																<span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?php echo e(URL::asset('public_theme/assets/images/users/6.jpg')); ?>"></span>
															</div>
															<div class="d-flex">
																<div class="pr-3">
													...
													<a class="dropdown-item border-bottom">
														<div class="d-flex align-items-center">
															<div class="">
																<span class="avatar avatar-md brround align-self-center cover-image" data-image-src="<?php echo e(URL::asset('public_theme/assets/images/users/7.jpg')); ?>"></span>
															</div>
															<div class="d-flex">
																<div class="pr-3">
												...
												<div class=" text-center p-2 border-top">
													<a href="<?php echo e(url('/' . $page='#')); ?>" class="">See All Messages</a>
												</div>
											</div>
										</div>
										<div class="dropdown header-notify">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class=" text-center p-2 border-top">
													<a href="<?php echo e(url('/' . $page='#')); ?>" class="">View All Notifications</a>
												</div>
											</div>
										</div>
										<div class="dropdown profile-dropdown">
											<a href="<?php echo e(url('/' . $page='#')); ?>" class="nav-link pr-0 leading-none" data-toggle="dropdown">
												<span>
													<img src="<?php echo e(URL::asset('public_theme/assets/images/users/2.jpg')); ?>" alt="img" class="avatar avatar-md brround">
												</span>
											</a>
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="<?php echo e(url('/' . $page='#')); ?>" class="dropdown-item text-center user pb-0 font-weight-bold">Jessica</a>
													<span class="text-center user-semi-title">Web Designer</span>
													<div class="dropdown-divider"></div>
												</div>
												<a class="dropdown-item d-flex" href="<?php echo e(url('/' . $page='#')); ?>">
												...
												<form method="POST" action="<?php echo e(route('logout')); ?>">
													...
													<svg class="header-icon ml-3" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
													...
													<div class="mt-1"><?php echo e(__('Log Out')); ?></div>
												</a>
												</form>
											</div>
										</div> 
						...
						<!--/app header--><?php /**PATH C:\xampp\htdocs\apiLaravelLogtah\resources\views/layouts/theme/header.blade.php ENDPATH**/ ?>