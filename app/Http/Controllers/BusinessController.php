    ...
    */
    ...
    public function postRegister(LoginRequest $request)
    {
        ...
        try {
            ...
            $business_details = $request->only(['name', 'start_date', 'time_zone','country', 'state', 'capital', 'business_details', 'logo','registration_number',
                                                'city', 'zip_code', 'landmark', 'website', 'mobile', 'alternate_number','post_code']);
            ...
            // $path = 'public_uploads/'.time().'busins.png';
            ...
            $position =  Position::where('position_name','CEO')->first();
           if(!$position){
               $position =  Position::create(['position_name' => 'CEO']);
             } 
             
            $owner_details['business_id'] = $business->id;
            $owner_details['created_by'] = $user->id;
            $owner_details['position_id'] = $position->id;
           
             
            $member = Member::create_admin_member($owner_details);
