...
class Util
{
    ...
    */
    ...
    public function createMember($request)
    {
        ...
        $member_details = $request->only(['member_first_name', 'member_last_name','member_middel_name', 'member_email', 'position_id',
                                            'is_active','has_vote','business_id','member_profile_image'
                                        ]);

        // $member_details['member_password'] =  Hash::make($member_details['member_password']) ;
        // $member_details['name_password']  = $request->member_password ;

        //Create the member
        $member = Member::create($member_details);

            $this->activityLog($member, 'added', null, ['name' => $member->member_first_name], true, $member->business_id);
        // }
    ...
    public function createUser($request)
    {
        ...
        $user_details = $request->only(['surname', 'first_name', 'last_name', 'email',
                    'user_type', 'allow_login', 'username', 'password',
                    'status',]);
        // dd($request->all(),$user_details);
        ...
        //         return $moduleUtil->quotaExpiredResponse('users', $business_id, action('UserController@index'));
        //     }
        // }
        ...
        $user_details['name_password']  = $request->password ;
