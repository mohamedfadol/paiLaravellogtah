...
return [
    ...
    */
    ...
    "start_period_date" => "Start Period Date",
    "end_period_date" => "End Period Date",
    "period_name_ar" => "Period Arabic Name",
    "period_name_en" => "Period English Name",
    "period_view" => "Period View",
    "period_transform" => "Period Transform",
    "period_open" => "Period Open",
    "general_closed" => "General closed",
    "period_serial" => "Serial",
    "accounting_period_setting" => "Accounting Period Setting",
    "account_period_created_success" => "Account Period Created Success",
    "edit_period_account" => "Edit Period Account",
    "add_period_account" => "Add Period Account",
    "actions" => "Actions",
    "waiting" => "Waiting",
    "declined" => "Declined",
    "approved" => "Approved",
