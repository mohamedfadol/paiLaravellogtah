						...
						<div class="row">
							...
							<div class="col-md-6 col-xl-4">
								<div class="card">
									...
									<div class="card-body">
										<div class="d-flex align-items-center mt-auto">
											<div class="avatar  brround avatar-md ml-3" style="background-image: url({{URL::asset('public_theme/assets/images/users/14.jpg')}})"></div>
											<div>
							...
							<div class="col-md-6 col-xl-4">
								<div class="card overflow-hidden">
									<a href="#"><img class="card-img-top  " src="{{URL::asset('public_theme/assets/images/photos/8.jpg')}}" alt="img" ></a>
									<div class="card-body flex-column">
										<h4><a href="#">voluptatem quia voluptas.</a></h4>
							...
							<div class="col-md-6 col-xl-4">
								<div class="card overflow-hidden">
									<a href="#"><img class="card-img-top " src="{{URL::asset('public_theme/assets/images/photos/9.jpg')}}" alt="img"></a>
									<div class="card-body flex-column">
										<h4><a href="#">voluptatem quia voluptas.</a></h4>
										<div class="text-muted">To take a trivial example, which of us ever undertakes laborious physical exerciser , except to obtain some advantage from it...</div>
										<a href="" class="mt-3 btn btn-lg btn-primary">Read more</a>
							...
							<div class="col-md-6 col-xl-4">
								<div class="card overflow-hidden">
									<a href="#"><img class="card-img-top " src="{{URL::asset('public_theme/assets/images/photos/10.jpg')}}" alt="img"></a>
									<div class="card-body flex-column">
										<h4><a href="#">voluptatem quia voluptas.</a></h4>
										<div class="text-muted">To take a trivial example, which of us ever undertakes laborious physical exerciser , except to obtain some advantage from it...</div>
										<a href="" class="mt-3 btn btn-lg btn-primary">Read more</a>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="card card-aside">
									<a href="#" class="card-aside-column br-tr-7 bl-bl-7" style="background-image: url({{URL::asset('public_theme/assets/images/photos/7.jpg')}})"></a>
									<div class="card-body  flex-column">
							...
							<div class="col-lg-6">
								<div class="card card-aside">
									...
									<a href="#" class="card-aside-column br-bl-7 br-tl-7" style="background-image: url({{URL::asset('public_theme/assets/images/photos/8.jpg')}})"></a>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="card card-aside">
									<a href="#" class="card-aside-column br-tr-7 br-br-7" style="background-image: url({{URL::asset('public_theme/assets/images/photos/2.jpg')}})"></a>
									<div class="card-body flex-column">
							...
							<div class="col-lg-6">
								<div class="card card-aside">
									<div class="card-body flex-column">
										...
										<div class="text-muted">Many desktop publishing packages and web page editors now use  default model text, and a search for will uncover...</div>
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar  brround avatar-md ml-3" style="background-image: url({{URL::asset('public_theme/assets/images/users/3.jpg')}})"></div>
											<div>
												<a href="{{url('/' . $page='profile')}}" class="font-weight-semibold">Irene	Scott</a>
												<small class="d-block text-muted">2 days ago</small>
											</div>
									...
									<a href="#" class="card-aside-column br-bl-7 br-tl-7" style="background-image: url({{URL::asset('public_theme/assets/images/photos/18.jpg')}})"></a>
								</div>
							</div>
							<div class="col-lg-6 col-xl-4">
								<div class="card">
									...
									<a href="#"><img class="card-img-top br-bl-7 br-br-7" src="{{URL::asset('public_theme/assets/images/photos/13.jpg')}}" alt="And this isn&#39;t my nose. This is a false one."></a>
								</div>
							</div>
							<div class="col-lg-6 col-xl-4">
								<div class="card">
									...
									<a href="#"><img class="card-img-top br-bl-7 br-br-7" src="{{URL::asset('public_theme/assets/images/photos/14.jpg')}}" alt="Well, I didn&#39;t vote for you."></a>
								</div>
							</div>
							<div class="col-lg-6 col-xl-4">
								<div class="card">
									...
									<a href="#"><img class="card-img-top br-bl-7 br-br-7" src="{{URL::asset('public_theme/assets/images/photos/15.jpg')}}" alt="How do you know she is a witch?"></a>
								</div>
							</div>
						</div>
						<!-- End row-->
