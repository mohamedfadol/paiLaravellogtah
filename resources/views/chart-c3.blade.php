...
@section('css')
		...
		<link href="{{URL::asset('public_theme/assets/plugins/charts-c3/c3-chart.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-bar-chart-2 ml-2 fs-14 float-right mt-1"></i>Charts</a></li>
...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/charts-c3/d3.v5.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/charts-c3/c3-chart.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/charts.js')}}"></script>
@endsection