						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/' . $page='#')}}">Card-Images</a></li>
								</ol>
							</div>
...
@section('content')
						...
						<div class="row">
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
									<img  src="{{URL::asset('public_theme/assets/images/photos/2.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
							...
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
									...
									<img  src="{{URL::asset('public_theme/assets/images/photos/1.jpg')}}" alt="image" class="card-image1 ">
								</div>
							</div>
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
									<img  src="{{URL::asset('public_theme/assets/images/photos/5.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
										<h5 class="card-title mb-3">Card title</h5>
										<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
							...
							<div class="col-md-6 col-lg-4">
								<div class="card">
									...
									<img  src="{{URL::asset('public_theme/assets/images/photos/6.jpg')}}" alt="image">
									<div class="card-body">
										<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									</div>
								</div>
							...
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
									<img  src="{{URL::asset('public_theme/assets/images/photos/10.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
							...
							<div class="col-md-6 col-lg-4">
								<div class="card overflow-hidden">
								<img  src="{{URL::asset('public_theme/assets/images/photos/8.jpg')}}" alt="image">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
								...
								<div class="card card-blog-overlay ">
									<div class="card-header z-index-10">
										...
										<div class="card-options">
											<a href="{{url('/' . $page='#')}}" class="card-options-collapse ml-2" data-toggle="card-collapse"><i class="fe fe-chevron-up text-white"></i></a>
							...
							<div class="col-md-12 col-xl-6">
								<div class="card ">
									<div class="card-header ">
										...
										<div class="card-options">
											<a href="{{url('/' . $page='#')}}" class="card-options-collapse ml-2" data-toggle="card-collapse"><i class="fe fe-chevron-up "></i></a>
							...
							<div class="col-md-12 col-xl-6">
								<div class="card card-aside">
									<div class="card-body flex-column">
										<h4><a href="{{url('/' . $page='#')}}">Play Music</a></h4>
									...
									<a href="{{url('/' . $page='#')}}" class="card-aside-column br-tl-7 br-bl-7 w-50" style="background-image: url({{URL::asset('public_theme/assets/images/photos/2.jpg')}})"></a>
								</div>
							</div>
							<div class="col-md-12 col-xl-6">
								<div class="card card-aside bg-primary">
									<div class="card-body  flex-column">
										<h4><a href="{{url('/' . $page='#')}}" class="text-white">Play Music</a></h4>
									...
									<a href="{{url('/' . $page='#')}}" class="card-aside-column br-tl-7 br-bl-7 w-50" style="background-image: url({{URL::asset('public_theme/assets/images/photos/20.jpg')}})"></a>
								</div>
							</div>
								...
								<div class="card ">
									<div class="card-header ">
										...
										<div class="card-options">
											...
											<a href="{{url('/' . $page='#')}}" class="card-options-remove mr-2" data-toggle="card-remove"><i class="fe fe-x "></i></a>
										</div>
									</div>
									<div class="card-body text-center">
										<img src="{{URL::asset('public_theme/assets/images/users/16.jpg')}}" class="avatar avatar-xxl brround" alt="">
							...
							<div class="col-md-12 col-lg-6">
								<div class="card ">
									...
									<div class="card-body text-center">
										<img src="{{URL::asset('public_theme/assets/images/users/10.jpg')}}" class="avatar avatar-xxl brround" alt="">
						...
						<div class="card">
							...
							<div class="card-group p-5">
								<div class="card shadow-none border border-left-0 overflow-hidden">
									<img  src="{{URL::asset('public_theme/assets/images/photos/10.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
										<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
								...
								<div class="card shadow-none border border-left-0 overflow-hidden">
									<img  src="{{URL::asset('public_theme/assets/images/photos/11.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
								...
								<div class="card shadow-none border overflow-hidden">
									<img  src="{{URL::asset('public_theme/assets/images/photos/12.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
						...
						<div class="card">
							...
							<div class="card-group p-5">
								<div class="card  overflow-hidden shadow-none border border-left-0">
									<img  src="{{URL::asset('public_theme/assets/images/photos/13.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
										<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
									</div>
								...
								<div class="card  overflow-hidden shadow-none border border-left-0">
									<img  src="{{URL::asset('public_theme/assets/images/photos/14.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
										<p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
									</div>
								...
								<div class="card overflow-hidden shadow-none border">
									<img  src="{{URL::asset('public_theme/assets/images/photos/15.jpg')}}" alt="image" class="card-image1 ">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
										<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
									</div>
