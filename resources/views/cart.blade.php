								...
								<div class="card">
									...
									<div class="card-body ">
												...
												<tbody>
													<tr>
														<td>
															<div class="d-flex w-200">
																<div>
																	<img src="{{URL::asset('public_theme/assets/images/products/1.jpg')}}" alt="img" title="" class="w-7 h-7">
																</div>
																<h6 class="mb-0 mt-4 font-weight-bold mr-4">flower pot</h6>
															</div>
														</td>
														<td>
													...
													<tr>
														<td>
															<div class="d-flex w-200">
																<div>
																	<img src="{{URL::asset('public_theme/assets/images/products/8.jpg')}}" alt="img" title="" class="w-7 h-7">
																</div>
																<h6 class="mb-0 mt-4 font-weight-bold mr-4">Desktop</h6>
															</div>
														</td>
														<td>
															<div class="input-group">
													...
													<tr>
														<td>
															<div class="d-flex w-200">
																<div>
																	<img src="{{URL::asset('public_theme/assets/images/products/9.jpg')}}" alt="img" title="" class="w-7 h-7">
																</div>
																<h6 class="mb-0 mt-4 font-weight-bold mr-4">Kurti</h6>
															</div>
														</td>
														<td>
															<div class="input-group">
													...
													<tr>
														<td>
															<div class="d-flex w-200">
																<div>
																	<img src="{{URL::asset('public_theme/assets/images/products/4.jpg')}}" alt="img" title="" class="w-7 h-7">
																</div>
																<h6 class="mb-0 mt-4 font-weight-bold mr-4">Laptop</h6>
															</div>
														</td>
														<td>
															<div class="input-group">
													...
													<tr>
														<td>
															<div class="d-flex w-200">
																<div>
																	<img src="{{URL::asset('public_theme/assets/images/products/6.jpg')}}" alt="img" title="" class="w-7 h-7">
																</div>
																<h6 class="mb-0 mt-4 font-weight-bold mr-4">Camera</h6>
															</div>
														</td>
														<td>
															<div class="input-group">
										...
										<div class=" float-left">
											<a href="{{url('/' . $page='shop')}}" class="btn btn-info mt-2"><i class="fe fe-arrow-right float-right mt-1 mr-1"></i> Continue Shopping</a>
											<a href="{{url('/' . $page='cart')}}" class="btn btn-primary mt-2">Update Cart</a>
											<a href="#" class="btn btn-secondary mt-2">Checkout <i class="fe fe-arrow-left float-left mt-1 mr-1"></i></a>
										</div>
									</div>
								</div>
								<!-- End Cart -->
