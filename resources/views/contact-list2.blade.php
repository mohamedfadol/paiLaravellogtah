									...
									<div class="main-content-left main-content-left-contacts">
										...
										<div class="main-contacts-list" id="mainContactList">
											...
											<div class="main-contact-item selected">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/12.jpg')}}" class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
													<h6>Arlena Soles</h6><span class="phone">+1-457-658-856</span>
												</div>
											</div>
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/1.jpg')}}" class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
													<h6>Athena Manske</h6><span>+1-457-658-856</span>
												</div>
											</div>
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/3.jpg')}}" class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/4.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
													<h6>Bret Guadalupe</h6><span>+1-457-658-856</span>
												</div>
											</div>
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/5.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/6.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
													<h6>Chassidy Kerr</h6><span>+1-457-658-856</span>
												</div>
											</div>
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/7.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/8.jpg')}}"  class="avatar avatar-md brround"></div>
												<div class="main-contact-body">
										...
										<div class="main-contact-info-header">
											<div class="media">
												<div class="main-img-user brround">
													<img alt="" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="w-100 h-100 brround">
												...
												<div class="media-body">
													...
													<p>Web Designer</p>
													<nav class="nav">
														<a class="nav-link" href=""><i class="fe fe-phone ml-1"></i> Call</a>
														<a class="nav-link" href=""><i class="fe fe-mail ml-1"></i> Message</a>
														<a class="nav-link" href=""><i class="fe fe-user-plus ml-1"></i> Add to Group</a>
														<a class="nav-link" href=""><i class="fe fe-slash ml-1"></i> Block</a>
													</nav>
												</div>
											</div>
											<div class="main-contact-action">
												<a href="" class="btn btn-light btn-svgs"><i class="fe fe-edit ml-1"></i> Edit <span> Contact</span></a>
												<a href="" class="btn btn-danger btn-svgs"><i class="fe fe-trash-2 ml-1"></i><span>Contact</span></a>
											</div>
											<!-- main-contact-action -->
										</div>
										<div class="main-contact-info-body">
											...
											<div class="media-list p-0">
												<div class="media py-4 mt-0">
													<div class="media-body">
														<div class="d-flex">
															<div class="media-icon bg-light text-primary ml-3 mt-1">
...
@section('js')
		<!--INTERNAL  Contact js -->
		<script src="{{URL::asset('public_theme/assets/js/contact.js')}}"></script>
@endsection