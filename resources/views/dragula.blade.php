...
@section('css')
		<!-- INTERNALDragula Css -->
		<link href="{{URL::asset('public_theme/assets/plugins/dragula/dragula.css')}}" rel="stylesheet">
@endsection
@section('page-header')
						<!--Page header-->
							...
							<div class="parent1 row">
										...
										<div class="card border shadow-none overflow-hidden br-3 mb-4">
											...
											<div class="card-body d-flex flex-column p-3">
												...
												<div class="d-flex align-items-center pt-5 mt-auto text-center">
													<div class="text-muted">
														<a class="icon d-none d-md-inline-block ml-3" href="javascript:void(0)"><i class="fa fa-step-forward"></i></a> <a class="icon d-none d-md-inline-block ml-3" href="javascript:void(0)"><i class="fa fa-play"></i></a> <a class="icon d-none d-md-inline-block ml-3" href="javascript:void(0)"><i class="fa fa-step-backward"></i></a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="card-body p-3">
												<div class="d-flex mt-0">
													<figure class="rounded-circle align-self-start mb-0">
														<img alt="Generic placeholder image" class="avatar brround avatar-xs ml-3" src="{{URL::asset('public_theme/assets/images/users/1.jpg')}}">
													</figure>
									...
									<div class="card p-5" id="right-defaults">
										...
										<div class="card border shadow-none overflow-hidden mb-4 br-3">
											...
											<div class="card-body p-3">
												<div class="d-flex mt-0">
													<figure class="rounded-circle align-self-start mb-0">
														<img alt="Generic placeholder image" class="avatar brround avatar-xs ml-3" src="{{URL::asset('public_theme/assets/images/users/13.jpg')}}">
													</figure>
													<div class="media-body mt-1">
										...
										<div class="card overflow-hidden br-3 border shadow-none overflow-hidden">
											<div class="card-status card-status-left bg-blue br-bl-7 br-tl-7"></div>
											<a href="#"><img class="card-img-top  " src="{{URL::asset('public_theme/assets/images/photos/1.jpg')}}" alt="img"></a>
											<div class="card-body d-flex flex-column p-3">
												Who chooses to enjoy a pleasure that has no annoying consequences
											</div>
										</div>
								...
								<div class="wrapper col-lg-4">
									<div class="card p-5" id="left-events">
										...
										<div class="card overflow-hidden br-3 border shadow-none overflow-hidden">
											<div class="card-status card-status-left bg-blue br-bl-7 br-tl-7"></div>
											<a href="#"><img class="card-img-top  " src="{{URL::asset('public_theme/assets/images/photos/6.jpg')}}" alt="img"></a>
											<div class="card-body d-flex flex-column p-3">
												Who chooses to enjoy a pleasure that has no annoying consequences
											</div>
										</div>
...
@section('js')
		<!-- INTERNAL Dragula Js -->
		<script src="{{URL::asset('public_theme/assets/plugins/dragula/dragula.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/dragula/example.min.js')}}"></script>
@endsection