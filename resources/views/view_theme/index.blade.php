									...
									<div class="card-body">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('public_theme/assets/images/users/1.jpg')}}" alt="img" class="avatar brround avatar-md">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('public_theme/assets/images/users/9.jpg')}}" alt="img" class="avatar brround avatar-md">
														<div class="media-body mr-3">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" alt="img" class="avatar brround avatar-md">
														<div class="media-body mr-3">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('public_theme/assets/images/users/11.jpg')}}" alt="img" class="avatar brround avatar-md">
														<div class="media-body mr-3">
															<div class="d-md-flex align-items-center mt-1">
										...
										<div class="list-card">
											...
											<div class="row align-items-center">
												<div class="col-9 col-sm-9">
													<div class="media mt-0">
														<img src="{{URL::asset('public_theme/assets/images/users/3.jpg')}}" alt="img" class="avatar brround avatar-md">
														<div class="media-body mr-3">
															<div class="d-md-flex align-items-center mt-1">
																<h6 class="mb-1">Joseph Abraham</h6>
															</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="country-card">
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('public_theme/assets/images/flags/us.svg')}}" class="w-5 h-5 ml-2" alt="">United States</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('public_theme/assets/images/flags/in.svg')}}" class="w-5 h-5 ml-2" alt="">India</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('public_theme/assets/images/flags/ru.svg')}}" class="w-5 h-5 ml-2" alt="">Russia</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('public_theme/assets/images/flags/ca.svg')}}" class="w-5 h-5 ml-2" alt="">Canada</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('public_theme/assets/images/flags/ge.svg')}}" class="w-5 h-5 ml-2" alt="">Germany</span>
											...
											<div class="mb-5">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('public_theme/assets/images/flags/br.svg')}}" class="w-5 h-5 ml-2" alt="">Brazil</span>
											...
											<div class="mb-0">
												<div class="d-flex">
													<span class=""><img src="{{URL::asset('public_theme/assets/images/flags/au.svg')}}" class="w-5 h-5 ml-2" alt="">Australia</span>
									...
									<div class="card-body">
										<div class="table-responsive">
											<table class="table table-vcenter text-nowrap mb-0 table-striped table-bordered border-top">
												...
												<tbody>
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('public_theme/assets/images/orders/7.jpg')}}" alt="media1"> New Book</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('public_theme/assets/images/orders/8.jpg')}}" alt="media1"> New Bowl</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('public_theme/assets/images/orders/9.jpg')}}" alt="media1"> Modal Car</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('public_theme/assets/images/orders/10.jpg')}}" alt="media1"> Headset</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('public_theme/assets/images/orders/12.jpg')}}" alt="media1"> Watch</td>
													...
													<tr>
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('public_theme/assets/images/orders/13.jpg')}}" alt="media1"> Branded Shoes</td>
													...
													<tr class="mb-0">
														<td class="font-weight-bold"><img class="w-7 h-7 rounded shadow ml-3" src="{{URL::asset('public_theme/assets/images/orders/11.jpg')}}" alt="media1"> New EarPhones</td>
