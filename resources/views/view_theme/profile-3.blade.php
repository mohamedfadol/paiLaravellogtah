						...
						<div class="row">
							<div class="col-xl-3 col-lg-3 col-md-12">
									...
									<div class="card-body">
										<div class="main-profile-contact-list">
											<div class="media ml-5 mt-0">
												<div class="media-icon bg-success text-white ml-4">
											...
											<div class="media ml-5">
												<div class="media-icon bg-danger text-white ml-4">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="main-profile-contact-list">
											<div class="media ml-4 mt-0">
												<div class="media-icon bg-primary text-white ml-3 mt-1">
											...
											<div class="media ml-4">
												<div class="media-icon bg-warning text-white ml-3 mt-1">
											...
											<div class="media">
												<div class="media-icon bg-info text-white ml-3 mt-1">
													<i class="fa fa-map"></i>
												</div>
												<div class="media-body">
								...
								<div class="card">
									...
									<div class="card-body pb-0">
										...
										<div class="media mg-t-15 profile-footer">
											...
											<div class="media-body">
												<h6 class="mb-0 mt-4 mr-2">28 people like your photo</h6>
											</div>
											<div class="mr-auto">
