...
@section('css')
		...
		<link href="{{URL::asset('assets/plugins/notify/css/jquery.growl-rtl.css')}}" rel="stylesheet" />
		<link href="{{URL::asset('assets/plugins/notify/css/notifIt-rtl.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
...
@section('js')
		...
		<script src="{{URL::asset('assets/plugins/notify/js/sample-rtl.js')}}"></script>
