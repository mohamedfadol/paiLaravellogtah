...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-grid ml-2 fs-14 float-right"></i>Widgets</a></li>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="row mr-0 ml-0">
										<div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0 border-left">
											<div class="card-body text-center">
												<p class="mb-1">Visits</p>
									            <h2 class="mb-1 font-weight-bold">3,56,667</h2>
												<span class="mb-0 text-muted"><span class="text-success"><i class="fa fa-caret-up  ml-1"></i> 0.7%</span> Last month</span>
									        </div>
										</div>
										<div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0 border-left">
											<div class="card-body text-center">
									            ...
									            <span class="mb-0 text-muted"><span class="text-success"><i class="fa fa-caret-up  ml-1"></i> 0.2%</span> Last month</span>
									        </div>
										</div>
										<div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0 border-left">
											<div class="card-body text-center">
									            ...
									            <span class="mb-0 text-muted"><span class="text-danger"><i class="fa fa-caret-down  ml-1"></i> 12%</span> Last month</span>
									        </div>
										</div>
										<div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0 border-left">
											<div class="card-body text-center">
										...
										<div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0 border-left">
											<div class="card-body text-center">
									            ...
									            <span class="mb-0 text-muted"><span class="text-danger"><i class="fa fa-caret-down  ml-1"></i> 1.2%</span> Last month</span>
									        </div>
										</div>
										<div class="col-xl-2 col-lg-6 col-sm-6 pr-0 pl-0">
											<div class="card-body text-center">
									            ...
									            <span class="mb-0 text-muted"><span class="text-danger"><i class="fa fa-caret-down  ml-1"></i> 0.6%</span> Last month</span>
									        </div>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<span class="mb-1 text-muted"><span class="text-danger"><i class="fa fa-caret-down  ml-1"></i> 43.2</span> than last month</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<span class="mb-1 text-muted"><span class="text-success"><i class="fa fa-caret-up  ml-1"></i> 19.8</span> than last month</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<span class="mb-1 text-muted"><span class="text-success"><i class="fa fa-caret-up  ml-1"></i> 0.8%</span> than last month</span>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="d-flex mb-3">
											<div class="icon icon-shape bg-primary rounded-circle text-white mb-0 ml-3">
												<div>04</div>
											</div>
											<div>
										...
										<div class="d-flex">
											<div class="icon icon-shape bg-secondary rounded-circle text-white mb-0 ml-3">
												<div>04</div>
											</div>
											<div>
												<p class="mb-1">New Modal Technologies<br> <b>Software Pvt ltd</b></p>
							...
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<span class="mb-1 text-muted"><span class="text-danger"><i class="fa fa-caret-down  ml-1"></i> 43.2</span> vs $56,699 than last month</span>
							...
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<span class="mb-1 text-muted"><span class="text-success"><i class="fa fa-caret-up  ml-1"></i> 19.8</span> vs $36,144 than last month</span>
										<div class="progress progress-xs mt-3">
							...
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<span class="mb-1 text-muted"><span class="text-success"><i class="fa fa-caret-up  ml-1"></i> 0.8%</span> vs 1.6% than last month</span>
										<div class="progress progress-xs mt-3">
									...
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="{{URL::asset('assets/images/users/1.jpg')}}" alt="Generic placeholder image" class="avatar brround avatar-md ml-3">
											</figure>
							...
							<div class="col-lg-12 col-xl-4 col-sm-12">
								<div class="card mb-5">
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="{{URL::asset('assets/images/users/16.jpg')}}" alt="Generic placeholder image" class="avatar brround avatar-md ml-3">
											</figure>
											<div class="media-body time-title1 ">
							...
							<div class="col-lg-12 col-xl-4 col-sm-12">
								<div class="card mb-5">
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="{{URL::asset('assets/images/users/3.jpg')}}" alt="Generic placeholder image" class="avatar brround avatar-md ml-3">
											</figure>
											<div class="media-body time-title1">
