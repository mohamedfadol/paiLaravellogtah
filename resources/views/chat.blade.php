									...
									<div class="tile tile-alt mb-0" id="messages-main">
											...
											<div class="tab-content">
												<div class="tab-pane active" id="tab-7">
													<ul class="list-group lg-alt chat-conatct-list" id="ChatList">
														<li class="list-group-item media p-4 mt-0 border-0">
															<a href="#">
																<div class="float-right pl-2">
																	<img src="{{URL::asset('public_theme/assets/images/users/5.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
																	<div class="list-group-item-heading text-default font-weight-semibold">Davil Parnell<span class="dot-label bg-danger mr-2 w-2 h-2"></span></div>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="float-right pl-2">
																	<img src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
																	<div class="list-group-item-heading text-default font-weight-semibold">Ann Watkinson<span class="dot-label bg-success mr-2 w-2 h-2"></span></div>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="float-right pl-2">
																	<img src="{{URL::asset('public_theme/assets/images/users/7.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
																	<div class="list-group-item-heading text-default font-weight-semibold">Marse Walter<span class="dot-label bg-success mr-2 w-2 h-2"></span></div>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="lv-avatar float-right pl2">
																	<img src="{{URL::asset('public_theme/assets/images/users/3.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
																	<div class="list-group-item-heading text-default font-weight-semibold">Jeremy Robbins<span class="dot-label bg-danger mr-2 w-2 h-2"></span></div>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="lv-avatar float-right pl-2">
																	<img src="{{URL::asset('public_theme/assets/images/users/9.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
																	<div class="list-group-item-heading text-default font-weight-semibold">Reginald Horace<span class="dot-label bg-danger mr-2 w-2 h-2"></span></div>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																<div class="float-right pl-2">
																	<img src="{{URL::asset('public_theme/assets/images/users/6.jpg')}}" alt="" class="avatar avatar-md brround">
																</div>
																<div class="media-body">
																	<div class="list-group-item-heading text-default font-weight-semibold">Shark Henry<span class="dot-label bg-success mr-2 w-2 h-2"></span></div>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																...
																<div class="media-body">
																	<div class="list-group-item-heading text-default font-weight-semibold">Paul Van Dack<span class="dot-label bg-danger mr-2 w-2 h-2"></span></div>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#">
																...
																<div class="media-body">
																	<div class="list-group-item-heading text-default font-weight-semibold">James Anderson<span class="dot-label bg-success mr-2 w-2 h-2"></span></div>
												...
												<div class="tab-pane" id="tab-8">
													<ul class="list-group lg-alt chat-conatct-list" id="ChatList2">
														<li class="list-group-item media p-4 border-0 mt-0">
															...
															<div class="ml-auto">
																...
																<ul class="dropdown-menu dropdown-menu-left">
																	<li>
																		<a href=""><i class="fe fe-phone-call ml-1 float-right"></i> Call</a>
																	</li>
																	<li>
																		<a href=""><i class="fe fe-video ml-1 float-right"></i> Videocall</a>
																	</li>
																	<li>
																		<a href=""><i class="fe fe-mail ml-1 float-right"></i> New Message</a>
																	</li>
																	<li>
																		<a href=""><i class="fe fe-settings ml-1 float-right"></i> Settings</a>
																	</li>
																</ul>
															</div>
														</li>
														...
														<li class="list-group-item media p-4 border-top mt-0">
															<a href="#" class="contact-href"></a>
															<div class="lv-avatar float-left pl-2">
																<img src="{{URL::asset('public_theme/assets/images/users/3.jpg')}}" alt="" class="avatar avatar-md brround">
															</div>
															<div class="media-body">
										...
										<div class="ms-body">
											<div class="action-header clearfix">
												...
												<div class="float-right hidden-xs d-flex mr-4 chat-user">
													<img src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" alt="" class="avatar avatar-lg brround ml-2">
											...
											<div class="chat-body-style" id="ChatBody">
												...
												<div class="message-feed right">
													<div class="float-left pr-2">
														<img src="{{URL::asset('public_theme/assets/images/users/10.jpg')}}" alt="" class="avatar avatar-md brround">
													</div>
													<div class="media-body">
														<div class="mf-content">
															...
															<div class="row mt-2">
																<div class="col-4">
																	<img class="img-fluid rounded" src="{{URL::asset('public_theme/assets/images/photos/19.jpg')}}" alt="banner image">
																</div>
																<div class="col-4">
																	<img class="img-fluid rounded" src="{{URL::asset('public_theme/assets/images/photos/11.jpg')}}" alt="banner image">
																</div>
																<div class="col-4">
																	<img class="img-fluid rounded" src="{{URL::asset('public_theme/assets/images/photos/8.jpg')}} " alt="banner image">
																</div>
															</div>
														</div>
...
@section('js')
		<!-- INTERNAL Chat js-->
		<script src="{{URL::asset('public_theme/assets/js/chat.js')}}"></script>
@endsection