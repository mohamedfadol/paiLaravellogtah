										...
										<div class="d-flex order-lg-2 mr-auto">
											...
											<div class="dropdown d-none d-md-flex mt-1">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
													...
													<a href="#" class="dropdown-item d-flex pb-3">
														<span class="avatar brround ml-3 align-self-center" style="background-image: url({{URL::asset('public_theme/assets/images/users/4.jpg')}})"></span>
														<div>
													...
													<a href="#" class="dropdown-item d-flex pb-3">
														<span class="avatar brround ml-3 align-self-center" style="background-image: url({{URL::asset('public_theme/assets/images/users/1.jpg')}})"></span>
														<div>
													...
													<a href="#" class="dropdown-item d-flex pb-3">
														<span class="avatar brround ml-3 align-self-center" style="background-image: url({{URL::asset('public_theme/assets/images/users/8.jpg')}})"></span>
														<div>
											...
											<div class="dropdown ">
												<a href="#" class="nav-link pr-0 leading-none mt-1" data-toggle="dropdown">
													<span class="avatar avatar-md brround" style="background-image: url({{URL::asset('public_theme/assets/images/users/2.jpg')}})"></span>
												</a>
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
						...
						<div class="">
							<div class="header py-4 bg-primary br-bl-7 br-br-7">
								<div class="container">
									<div class="d-flex">
										<a class="header-brand" href="{{url('/' . $page='index')}}">
											<img src="{{URL::asset('public_theme/assets/images/brand/logo1.png')}}" class="header-brand-img desktop-lgo" alt="Admintro logo">
											<img src="{{URL::asset('public_theme/assets/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="Admintro logo">
										</a>
										<div class="d-flex order-lg-2 mr-auto">
								...
								<div class="container-fluid">
									<div class="d-flex">
										...
										<div class="d-flex order-lg-2 mr-auto">
											...
											<div class="dropdown   header-fullscreen pr-5" >
											...
											<div class="dropdown header-notify pl-4">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
													<a href="#" class="dropdown-item d-flex pb-3">
														<svg class="header-icon ml-4" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="">
							<!--app header-->
							<div class="header bg-primary br-bl-7 br-br-7 py-4">
								<div class="container-fluid">
									<div class="d-flex">
										<a class="header-brand" href="{{url('/' . $page='index')}}">
											<img src="{{URL::asset('public_theme/assets/images/brand/logo1.png')}}" class="header-brand-img desktop-lgo" alt="Admintro logo">
