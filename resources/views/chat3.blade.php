											...
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img  class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/1.jpg')}}" alt="img">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img  class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/16.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/3.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/4.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/5.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/6.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img  class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/9.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img  class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/10.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img  class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/11.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
									...
									<div class="col-xl-6">
										<div class="card">
											<div class="card-body p-0">
												<div class="chat-widget-header d-flex p-5">
													<div class="font-weight-bold d-flex">
														<img  class="avatat avatar-md brround ml-2" src="{{URL::asset('public_theme/assets/images/users/12.jpg')}}" alt="img">
														<div class="mt-1 d-none d-sm-block">
						...
						<div class="action-header">
							<div class="float-right hidden-xs d-flex ml-2">
								<div class="img_cont ml-3">
									<img src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="rounded-circle user_img avatar avatar-md" alt="img">
								</div>
								<div class="align-items-center mt-2 text-white">
									<h5 class="mb-0">Jessica</h5>
									<span class="dot-label bg-success"></span><span class="ml-3 fs-12">online</span>
								</div>
							</div>
						...
						<div class="card-body msg_card_body">
							...
							<div class="d-flex justify-content-start">
								<div class="img_cont_msg">
									<img src="{{URL::asset('public_theme/assets/images/users/9.jpg')}}" class="rounded-circle user_img_msg" alt="img">
								</div>
							...
							<div class="d-flex justify-content-end ">
								...
								<div class="img_cont_msg">
									<img src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="rounded-circle user_img_msg" alt="img">
								</div>
							</div>
							<div class="d-flex justify-content-start ">
								<div class="img_cont_msg">
