...
@section('css')
		...
		<link href="{{URL::asset('public_theme/assets/plugins/time-picker/jquery.timepicker.css')}}" rel="stylesheet" />

		<!-- INTERNAL Date Picker css -->
		<link href="{{URL::asset('public_theme/assets/plugins/date-picker/date-picker.css')}}" rel="stylesheet" />

		<!-- INTERNAL File Uploads css-->
        <link href="{{URL::asset('public_theme/assets/plugins/fileupload/css/fileupload.css')}}" rel="stylesheet" type="text/css" />

		<!-- INTERNAL Mutipleselect css-->
		<link rel="stylesheet" href="{{URL::asset('public_theme/assets/plugins/multipleselect/multiple-select-rtl.css')}}">

		<!-- INTERNAL Sumoselect css-->
		<link rel="stylesheet" href="{{URL::asset('public_theme/assets/plugins/sumoselect/sumoselect-rtl.css')}}">

		<!-- INTERNAL telephoneinput css-->
		<link rel="stylesheet" href="{{URL::asset('public_theme/assets/plugins/telephoneinput/telephoneinput-rtl.css')}}">

		<!-- INTERNAL Jquerytransfer css-->
		<link rel="stylesheet" href="{{URL::asset('public_theme/assets/plugins/jQuerytransfer/jquery.transfer-rtl.css')}}">
		<link rel="stylesheet" href="{{URL::asset('public_theme/assets/plugins/jQuerytransfer/icon_font/icon_font.css')}}">

		<!-- INTERNAL multi css-->
        <link rel="stylesheet" href="{{URL::asset('public_theme/assets/plugins/multi/multi.min.css')}}">
@endsection
@section('page-header')
						<!--Page header-->
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{url('/' . $page='#')}}"><i class="fe fe-file-text ml-2 fs-14 float-right"></i>Forms</a></li>
								...
								<form method="post" class="card">
									...
									<div class=" card-body">
										<div class="row">
											...
											<div class="col-lg-4 col-sm-12">
												<input type="file" class="dropify" data-default-file="{{URL::asset('public_theme/assets/images/photos/media1.jpg')}}" data-height="180"  />
											</div>
											<div class="col-lg-4 col-sm-12">
...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/time-picker/jquery.timepicker.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/time-picker/toggles.min.js')}}"></script>

		<!-- INTERNAL Datepicker js -->
		<script src="{{URL::asset('public_theme/assets/plugins/date-picker/date-picker.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/date-picker/jquery-ui.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/input-mask/jquery.maskedinput.js')}}"></script>

		<!-- INTERNAL File-Uploads Js-->
		<script src="{{URL::asset('public_theme/assets/plugins/fancyuploder/jquery.ui.widget.js')}}"></script>
        <script src="{{URL::asset('public_theme/assets/plugins/fancyuploder/jquery.fileupload.j')}}s"></script>
        <script src="{{URL::asset('public_theme/assets/plugins/fancyuploder/jquery.iframe-transport.js')}}"></script>
        <script src="{{URL::asset('public_theme/assets/plugins/fancyuploder/jquery.fancy-fileupload.js')}}"></script>
        <script src="{{URL::asset('public_theme/assets/plugins/fancyuploder/fancy-uploader.js')}}"></script>
		...
		<script src="{{URL::asset('public_theme/assets/plugins/multipleselect/multiple-select.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/multipleselect/multi-select.js')}}"></script>

		<!--INTERNAL Sumoselect js-->
		<script src="{{URL::asset('public_theme/assets/plugins/sumoselect/jquery.sumoselect.js')}}"></script>

		<!--INTERNAL telephoneinput js-->
		<script src="{{URL::asset('public_theme/assets/plugins/telephoneinput/telephoneinput.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/telephoneinput/inttelephoneinput.js')}}"></script>

		<!--INTERNAL jquery transfer js-->
		<script src="{{URL::asset('public_theme/assets/plugins/jQuerytransfer/jquery.transfer.js')}}"></script>

		<!--INTERNAL multi js-->
		<script src="{{URL::asset('public_theme/assets/plugins/multi/multi.min.js')}}"></script>

		<!--INTERNAL Form Advanced Element -->
		<script src="{{URL::asset('public_theme/assets/js/formelementadvnced.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/form-elements.js')}}"></script>
