...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/counters/jquery.missofis-countdown.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/counters/counter.js')}}"></script>

		<!--INTERNAl Counters -->
		<script src="{{URL::asset('public_theme/assets/plugins/counters/counterup.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/counters/waypoints.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/countdown/moment.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/countdown/moment-timezone.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/countdown/moment-timezone-with-data.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/countdown/countdowntime.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/counterup.js')}}"></script>
@endsection