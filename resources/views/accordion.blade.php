...
@section('css')
        ...
        <link href="{{URL::asset('public_theme/assets/plugins/accordion/accordion.css')}}" rel="stylesheet" />
		<!-- INTERNAL Prism Css -->
		<link href="{{URL::asset('public_theme/assets/plugins/prism/prism.css')}}" rel="stylesheet">ion
@endsect
@section('page-header')
						<!--Page header-->
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/' . $page='#')}}">Accordion</a></li>
								</ol>
							</div>
												...
												<div class="panel-heading " role="tab" id="headingOne1">
													<h4 class="panel-title">
														<a role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1">
															...
															<span class="float-left"><i class="fe fe-chevron-left"></i></span>
														</a>
													</h4>
												</div>
...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/accordion/accordion.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/accordion.js')}}"></script>
@endsection