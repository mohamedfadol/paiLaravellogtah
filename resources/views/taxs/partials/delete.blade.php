<div class="modal fade delete p-4 bg-light border border-bottom-0 mg-t-20" id="DeleTaxModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal d-block pos-static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    <form action="{{ route('taxs.destroy','test') }}" method="POST">
