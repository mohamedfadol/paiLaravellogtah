									...
									<div class="card-body">
										<div class="form-group">
											...
											<select name="country" id="select-countries" class="form-control custom-select select2">
												<option value="br" data-data='{"image": "{{URL::asset('public_theme/assets/images/flags/br.svg')}}"}'>Brazil</option>
												<option value="cz" data-data='{"image": "{{URL::asset('public_theme/assets/images/flags/cz.svg')}}"}'>Czech Republic</option>
												<option value="de" data-data='{"image": "{{URL::asset('public_theme/assets/images/flags/de.svg')}}"}'>Germany</option>
												<option value="pl" data-data='{"image": "{{URL::asset('public_theme/assets/images/flags/pl.svg')}}"}' selected>Poland</option>
											</select>
										</div>
										<div class="form-group">
