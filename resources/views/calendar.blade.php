...
@section('css')
		...
		<link href="{{URL::asset('public_theme/assets/plugins/fullcalendar/fullcalendar-rtl.css')}}" rel='stylesheet' />
		<link href="{{URL::asset('public_theme/assets/plugins/fullcalendar/fullcalendar.print.min.css')}}" rel='stylesheet' media='print' />
@endsection
@section('page-header')
						<!--Page header-->
...
@section('content')
						...
						<div class="card">
							<div class="row no-gutters">
										...
										<div class="card-body">
											<nav class="nav main-nav-column main-nav-calendar-event">
												<a class="nav-link w-100 d-flex" href="">
													<div class="w-4 h-4 brround bg-primary ml-3"></div>
													<div>Calendar Events</div>
												</a>
												<a class="nav-link w-100 d-flex" href="">
													<div class="w-4 h-4 brround bg-secondary ml-3"></div>
													<div>Birthday Events</div>
												</a>
												<a class="nav-link w-100 d-flex" href="">
													<div class="w-4 h-4 brround bg-success ml-3"></div>
													<div>Holiday Calendar</div>
												</a>
												<a class="nav-link w-100 d-flex" href="">
													<div class="w-4 h-4 brround bg-info ml-3"></div>
													<div>Other Calendar</div>
												</a>
												<a class="nav-link w-100 d-flex" href="">
													<div class="w-4 h-4 brround bg-warning ml-3"></div>
													<div>Office Calendar</div>
												</a>
												<a class="nav-link w-100 d-flex" href="">
													<div class="w-4 h-4 brround bg-danger ml-3"></div>
													<div>Work Calendar</div>
												</a>
												<a class="nav-link w-100 d-flex exclude" href="">
													<div class="w-4 h-4 brround bg-light ml-3"></div>
								...
								<div class="col-lg-9">
									<div class="main-content-body main-content-body-calendar card-body border-right">
...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/fullcalendar/moment.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/fullcalendar/fullcalendar.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/app-calendar-events.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/app-calendar.js')}}"></script>
@endsection