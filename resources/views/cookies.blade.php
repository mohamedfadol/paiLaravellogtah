...
@section('css')
		...
		<link href="{{URL::asset('public_theme/assets/plugins/cookies/accept-cookies-rtl.css')}}" rel="stylesheet" />
		<link href="{{URL::asset('public_theme/assets/plugins/cookies/cookies.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
...
@section('js')
		<!-- INTERNAL Cookies js-->
		<script src="{{URL::asset('public_theme/assets/plugins/cookies/cookiepopup.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/cookie.js')}}"></script>
@endsection