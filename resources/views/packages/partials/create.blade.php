<!-- modal-wrapper-User -->
<div class="modal fade p-4 bg-light border border-bottom-0 package_form_modal" id="CreatePackageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal d-block pos-static">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('packages.store') }}" method="POST" id="package_form">
                    @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 mb-0">
                                <div class="form-group">
                                    ...
                                    <span class="text-danger error-text package_price_error"></span>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12 mb-0">
                                ...
                                <label class="form-label">{{ __('message.interval') }}</label>
                                    <select name="interval" required class="@error('interval') is-invalid @enderror form-control custom-select select2">
