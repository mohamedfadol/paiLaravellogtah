...
@section('css')
		...
		<link href="{{URL::asset('public_theme/assets/plugins/jquery-countdown/jquery.countdown.css')}}" rel="stylesheet" type="text/css">
@endsection
@section('content')
				...
				<div class="container text-center">
					<div class="row">
						...
						<div class="col-md-6 d-none d-md-flex align-items-center">
							<img src="{{URL::asset('public_theme/assets/images/png/construction.png')}}" alt="img">
						</div>
					</div>
				</div>
			</div>
...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/jquery-countdown/jquery.plugin.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/jquery-countdown/jquery.countdown.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/jquery-countdown/countdown.js')}}"></script>
@endsection
