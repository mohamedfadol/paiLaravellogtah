...
@section('css')
		...
		<link href="{{URL::asset('public_theme/assets/plugins/img-crop/cropme.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
										...
										<div class="row no-gutters">
											...
											<div class="col-lg-7 col-xl-6">
												...
												<div class="btn-list p-3">
													...
													<button class="btn btn-success float-left"  @click="crop">Crop me</button>
													<button class="btn btn-primary float-left ml-3" @click="getPosition">Get position</button>
												</div>
											</div>
										</div>
									</div>
...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/img-crop/vue.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/img-crop/cropme.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/img-crop.js')}}"></script>
@endsection