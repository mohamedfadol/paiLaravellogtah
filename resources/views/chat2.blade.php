...
@section('css')
		...
		<link href="{{URL::asset('public_theme/assets/plugins/lightslider/css/lightslider.min.css')}}" rel="stylesheet">
@endsection
@section('page-header')
						<!--Page header-->
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-grid ml-2  fs-14 float-right mt-1"></i>Apps</a></li>
											...
											<div class="main-content-left main-content-left-chat">
												...
												<div class="main-chat-contacts-wrapper">
													...
													<div class="main-chat-contacts" id="chatActiveContacts">
														<div>
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/12.jpg')}}" class="avatar avatar-md brround"></div><small>Kecia</small>
														</div>
														<div>
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="avatar avatar-md brround"></div><small>Copp</small>
														</div>
														<div>
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/14.jpg')}}" class="avatar avatar-md brround"></div><small>Edwina</small>
														</div>
														<div>
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="avatar avatar-md brround"></div><small>Uriarte</small>
														</div>
														<div>
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/8.jpg')}}" class="avatar avatar-md brround"></div><small>Ambrose Cawthon</small>
														</div>
														<div>
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/3.jpg')}}" class="avatar avatar-md brround"></div><small>Cawthon</small>
														</div>
														<div>
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/11.jpg')}}" class="avatar avatar-md brround"></div><small>Celesta</small>
														</div>
														<div>
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/1.jpg')}}" class="avatar avatar-md brround"></div><small>Briones</small>
														</div>
														<div>
												...
												<div class="main-chat-list" id="ChatList">
													<a href="#">
														<div class="media new">
															<div class="main-img-user online">
																<img alt="" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="avatar avatar-md brround"><span>2</span>
															</div>
													...
													<a href="#">
														<div class="media new">
															<div class="main-img-user">
																<img alt="" src="{{URL::asset('public_theme/assets/images/users/8.jpg')}}" class="avatar avatar-md brround"><span>1</span>
															</div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media selected">
															<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/3.jpg')}}" class="avatar avatar-md brround"></div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media">
															<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/13.jpg')}}" class="avatar avatar-md brround"></div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media">
															<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/14.jpg')}}" class="avatar avatar-md brround"></div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media new">
															<div class="main-img-user">
																<img alt="" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="avatar avatar-md brround"> <span>1</span>
															</div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media">
															<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/7.jpg')}}" class="avatar avatar-md brround"></div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media">
															<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/5.jpg')}}" class="avatar avatar-md brround"></div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media">
															<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/6.jpg')}}" class="avatar avatar-md brround"></div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media">
															<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/12.jpg')}}" class="avatar avatar-md brround"></div>
															<div class="media-body">
																<div class="media-contact-name">
													...
													<a href="#">
														<div class="media">
															<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/8.jpg')}}" class="avatar avatar-md brround"></div>
															<div class="media-body">
																<div class="media-contact-name">
									...
									<div class="border-right">
										<div class="main-content-body main-content-body-chat">
											<div class="main-chat-header">
												<div class="main-img-user"><img alt="" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="avatar avatar-md brround"></div>
											...
											<div class="main-chat-body" id="ChatBody">
												<div class="content-inner">
													...
													<div class="media flex-row-reverse">
														<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" class="avatar avatar-md brround"></div>
														<div class="media-body">
													...
													<div class="media">
														<div class="main-img-user online"><img alt="" src="{{URL::asset('public_theme/assets/images/users/14.jpg')}}" class="avatar avatar-md brround"></div>
														<div class="media-body">
															<div class="main-msg-wrapper">
...
@section('js')
		<!-- lightslider js -->
		<script src="{{URL::asset('public_theme/assets/plugins/lightslider/js/lightslider.min.js')}}"></script>
		<!-- INTERNAL Chat js-->
		<script src="{{URL::asset('public_theme/assets/js/chat2.js')}}"></script>
@endsection