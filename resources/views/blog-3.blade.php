							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img px-4 pt-4">
										<a href="{{url('/' . $page='#')}}"></a>
										<img src="{{URL::asset('public_theme/assets/images/photos/blog.jpg')}}" alt="img" class="cover-image br-7 w-100">
									</div>
									<div class="card-body">
										<div class="item7-card-desc d-md-flex mb-5">
											<a href="{{url('/' . $page='#')}}" class="d-flex ml-4 mb-2"><i class="fe fe-calendar fs-16 ml-1"></i><div class="mt-0">Jan-18-2020</div></a>
											<a href="{{url('/' . $page='#')}}" class="d-flex mb-2"><i class="fe fe-user fs-16 ml-1"></i><div class="mt-0">Anna Ogden</div></a>
									...
									<div class="card-body">
										<div class="d-sm-flex mt-0 p-5 sub-review-section border border-bottom-0 br-bl-0 br-br-0">
											<div class="d-flex ml-3">
												<a href="{{url('/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('public_theme/assets/images/users/1.jpg')}}"> </a>
											</div>
											<div class="media-body Comments1">
												<h5 class="mt-0 mb-1 font-weight-semibold">Joanne Scott
													...
													<span class="fs-14 mr-2"> 4.5 <i class="fa fa-star text-yellow"></i></span>
												</h5>
												...
												<div class="btn-group btn-group-sm mb-1 mr-auto float-sm-left mt-1">
										...
										<div class="d-sm-flex p-5 sub-review-section border subsection-color br-tl-0 br-tr-0">
											<div class="d-flex ml-3">
												<a href="{{url('/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}"> </a>
											</div>
											<div class="media-body Comments1">
										...
										<div class="d-sm-flex p-5 mt-4 border sub-review-section">
											<div class="d-flex ml-3">
												<a href="{{url('/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('public_theme/assets/images/users/3.jpg')}}"> </a>
											</div>
											<div class="media-body Comments1">
												...
												<a href="" class="mr-2 mt-1" data-toggle="modal" data-target="#Comment"><span class="badge badge-light">Comment</span></a>
												<a href="" class="mr-2 mt-1" data-toggle="modal" data-target="#report"><span class="badge badge-light">Report</span></a>
												<div class="btn-group btn-group-sm mb-1 ml-auto float-sm-left mt-1">
													<button class="btn btn-light" type="button"><i class="fe fe-thumbs-up  fs-16 text-icon"></i></button>
													<button class="btn btn-light" type="button"><i class="fe fe-thumbs-down  fs-16 text-icon"></i></button>
												</div>
											</div>
