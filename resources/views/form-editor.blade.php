...
@section('css')
		<!-- INTERNAl Quill css -->
		<link href="{{URL::asset('public_theme/assets/plugins/quill/quill.snow.css')}}" rel="stylesheet">
		<link href="{{URL::asset('public_theme/assets/plugins/quill/quill.bubble-rtl.css')}}" rel="stylesheet">

		<!-- INTERNAl WYSIWYG Editor css -->
		<link href="{{URL::asset('public_theme/assets/plugins/wysiwyag/richtext-rtl.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
						<!--Page header-->
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-file-text ml-2 fs-14 float-right"></i>Forms</a></li>
...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/wysiwyag/jquery.richtext.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/form-editor.js')}}"></script>

		<!-- INTERNAL quill js -->
		<script src="{{URL::asset('public_theme/assets/plugins/quill/quill.min.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/form-editor2.js')}}"></script>
@endsection