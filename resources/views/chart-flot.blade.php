						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/' . $page='#')}}">Flot Charts</a></li>
								</ol>
							</div>
...
@section('js')
		...
		<script src="{{URL::asset('public_theme/assets/plugins/flot/jquery.flot.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/flot/jquery.flot.fillbetween.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/plugins/flot/jquery.flot.pie.js')}}"></script>
		<script src="{{URL::asset('public_theme/assets/js/flot.js')}}"></script>
@endsection