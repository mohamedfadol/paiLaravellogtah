									...
									<div class="card-body">
										<div class="email-media">
											<div class="mt-0 d-sm-flex">
												<img class="ml-2 rounded-circle avatar avatar-lg" src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" alt="avatar">
										...
										<div class="eamil-body mt-5">
											...
											<div class="row">
												<div class="col-sm-6 col-lg-3 mt-4">
													<a class="" href="{{url('/' . $page='#')}}">
														<div class="border p-0 text-center">
															<img src="{{URL::asset('public_theme/assets/images/files/file2.png')}}" alt="img" class="w-80 mx-auto">
														</div>
												...
												<div class="col-sm-6 col-lg-3 mt-4">
													<a class="" href="{{url('/' . $page='#')}}">
														<div class="border p-0 text-center">
															<img src="{{URL::asset('public_theme/assets/images/files/doc.png')}}" alt="img" class="w-80 mx-auto">
														</div>
														<div class="bg-light p-3">
