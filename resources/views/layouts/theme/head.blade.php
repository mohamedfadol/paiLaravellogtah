		...
		<!--Sidemenu css -->
        <link  href="{{URL::asset('public_theme/assets/css-rtl/sidemenu.css')}}" rel="stylesheet">

		<!-- P-scroll bar css-->
		<link href="{{URL::asset('public_theme/assets/plugins/p-scrollbar/p-scrollbar-rtl.css')}}" rel="stylesheet" />
        ...
        @yield('css')
		<!-- Simplebar css -->
		<link rel="stylesheet" href="{{URL::asset('public_theme/assets/plugins/simplebar/css/simplebar-rtl.css')}}">
	    <!-- Color Skin css -->
