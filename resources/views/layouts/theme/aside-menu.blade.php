				...
				<aside class="app-sidebar">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="">
							<img src="{{URL::asset('public_theme/assets/images/brand/logo.png')}}" class="header-brand-img desktop-lgo" alt="Admintro logo">
							<img src="{{URL::asset('public_theme/assets/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="Admintro logo">
							<img src="{{URL::asset('public_theme/assets/images/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="Admintro logo">
							<img src="{{URL::asset('public_theme/assets/images/brand/favicon1.png')}}" class="header-brand-img darkmobile-logo" alt="Admintro logo">
						</a>
					</div>
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							<div class="user-pic">
								<img src="{{URL::asset('public_theme/assets/images/users/2.jpg')}}" alt="user-img" class="avatar-xl rounded-circle mb-1">
							</div>
							<div class="user-info">
					...
					<ul class="side-menu app-sidebar3">
						...
						<li class="slide">
							...
							<ul class="slide-menu ">
								<li><a href="{{route('taxs.index')}}" class="slide-item">Taxs</a></li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="{{ route('users.index') }}" class="slide-item">Manage Users</a></li>
								<li><a href="{{ route('roles.index') }}" class="slide-item">MManage Role</a></li>
