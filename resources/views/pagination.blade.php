						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/' . $page='#')}}">Pagination</a></li>
								</ol>
							</div>
										...
										<div class="pagination-wrapper">
											<nav aria-label="Page navigation">
												<ul class="pagination mb-0">
													...
													<li class="page-item">
														<a class="page-link" href="{{url('/' . $page='#')}}">2</a>
													</li>
													<li class="page-item">
														<a class="page-link" href="{{url('/' . $page='#')}}">3</a>
													</li>
													<li class="page-item">
														<a class="page-link" href="{{url('/' . $page='#')}}">4</a>
													</li>
													<li class="page-item">
														<a class="page-link" href="{{url('/' . $page='#')}}">5</a>
													</li>
													<li class="page-item">
														<a aria-label="Next" class="page-link" href="{{url('/' . $page='#')}}"><i class="fa fa-angle-left"></i></a>
													</li>
												</ul>
											</nav>
										</div>
									...
									<div class="card-body">
										<ul class="pagination ">
											<li class="page-item page-prev disabled">
												<a class="page-link" href="{{url('/' . $page='#')}}" tabindex="-1">Prev</a>
											</li>
											<li class="page-item active"><a class="page-link" href="{{url('/' . $page='#')}}">1</a></li>
											<li class="page-item"><a class="page-link" href="{{url('/' . $page='#')}}">2</a></li>
											<li class="page-item"><a class="page-link" href="{{url('/' . $page='#')}}">3</a></li>
											<li class="page-item"><a class="page-link" href="{{url('/' . $page='#')}}">4</a></li>
											<li class="page-item page-next">
												<a class="page-link" href="{{url('/' . $page='#')}}">Next</a>
											</li>
										</ul>
										<!-- pagination-wrapper -->
									</div>
								...
								<div class="card">
									...
									<div class="card-body ">
										<ul class="pagination mg-b-0 page-0 ">
											<li class="page-item">
												<a aria-label="Last" class="page-link" href="{{url('/' . $page='#')}}"><i class="fa fa-angle-double-right"></i></a>
											</li>
											<li class="page-item">
												<a aria-label="Next" class="page-link" href="{{url('/' . $page='#')}}"><i class="fa fa-angle-right"></i></a>
											</li>
											...
											<li class="page-item">
												<a class="page-link hidden-xs-down" href="{{url('/' . $page='#')}}">4</a>
											</li>
											...
											<li class="page-item">
												<a aria-label="Last" class="page-link" href="{{url('/' . $page='#')}}"><i class="fa fa-angle-double-left"></i></a>
											</li>
										</ul>
									</div>
									<!-- pagination-wrapper -->
									...
									<div class="card-body">
										<nav aria-label="Page navigation">
											<ul class="pagination pagination-success mb-0">
												...
												<li class="page-item">
													<a class="page-link" href="{{url('/' . $page='#')}}">10</a>
												</li>
												<li class="page-item page-0">
													<a aria-label="Next" class="page-link" href="{{url('/' . $page='#')}}"><i class="fa fa-angle-left"></i></a>
												</li>
								...
								<div class="card">
									...
									<div class="card-body">
										<nav aria-label="Page navigation example">
											<ul class="pagination">
												<li class="page-item">
													<a class="page-link" href="{{url('/' . $page='#')}}" aria-label="Previous">
														<i class="fa fa-angle-right"></i>
														<span class="sr-only">Previous</span>
													</a>
												</li>
												<li class="page-item"><a class="page-link" href="{{url('/' . $page='#')}}">1</a></li>
												<li class="page-item"><a class="page-link" href="{{url('/' . $page='#')}}">2</a></li>
												<li class="page-item"><a class="page-link" href="{{url('/' . $page='#')}}">3</a></li>
												<li class="page-item">
													<a class="page-link" href="{{url('/' . $page='#')}}" aria-label="Next">
										...
										<nav aria-label="Page navigation example">
											<ul class="pagination ">
												<li class="page-item disabled">
													<a class="page-link" href="{{url('/' . $page='#')}}" tabindex="-1">
														<i class="fa fa-angle-right"></i>
														<span class="sr-only">Previous</span>
													</a>
												</li>
												<li class="page-item"><a class="page-link" href="{{url('/' . $page='#')}}">1</a></li>
												<li class="page-item active"><a class="page-link" href="{{url('/' . $page='#')}}">2</a></li>
												<li class="page-item"><a class="page-link" href="{{url('/' . $page='#')}}">3</a></li>
												<li class="page-item">
